...
<body class="index-page">
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <img src="assets/img/olahraga14.jpg" alt="" data-aos="fade-in" class="">
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="member">
                <a href="assets/img/speakers/speaker-1.jpg" class="glightbox" data-gallery="speakers-gallery">      <!--gambar dibungkus a href ben iso diklik-->
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="member">
                <a href="assets/img/speakers/speaker-2.jpg" class="glightbox" data-gallery="speakers-gallery">      <!--gambar dibungkus a href ben iso diklik-->
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="member">
                <a href="assets/img/speakers/speaker-3.jpg" class="glightbox" data-gallery="speakers-gallery">      <!--gambar dibungkus a href ben iso diklik-->
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="member">
                <a href="assets/img/speakers/speaker-4.jpg" class="glightbox" data-gallery="speakers-gallery">      <!--gambar dibungkus a href ben iso diklik-->
      ...
      <div class="container-fluid" data-aos="fade-up">
        <div class="row g-0 justify-content-center">
          <div class="col-lg-6 venue-map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3954.736866162736!2d111.89376177408232!3d-7.603588375150456!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e784b05bd50c375%3A0xf73a522d786df02e!2sGedung%20Juang%2045%20Nganjuk!5e0!3m2!1sid!2sid!4v1747927130013!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>        
        </div>
      </div>
        ...
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6 footer-about">
            <a href="index.html" class="logo d-flex align-items-center">
              <span class="sitename">Events</span>
            </a>
  ...
  <!-- Mengubah tampilan menjadi vertikal dan menambahkan teks -->
    ...
    <div class="copyright text-center">
      <div class="container d-flex flex-column flex-lg-row justify-content-center justify-content-lg-between align-items-center">
        ...
        <div class="d-flex flex-column align-items-center align-items-center">
          <div>
            © <strong><span>SportEase</span></strong>
          </div>
          <div class="credits">
